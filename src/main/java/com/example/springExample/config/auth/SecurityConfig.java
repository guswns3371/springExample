package com.example.springExample.config.auth;

import com.example.springExample.domain.user.Role;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    ...
                    // anyRequest
                    // 설정된 값 이오의 나머지 URL들을 나타낸다. authenticated()를 추가하여 나머지 URL들은 모두 인증된 사용자들(로그인한 사용자들)에게만 허용한다.
